...
#define	DEFAULT_MODEL			"promarine"
#if MISSIONPACK
#define	DEFAULT_TEAM_MODEL		"promarine"
#define	DEFAULT_TEAM_HEAD		"*promarine"
#else
#define	DEFAULT_TEAM_MODEL		"promarine"
#define	DEFAULT_TEAM_HEAD		"promarine"
#endif
...
typedef struct {
	...
	int				scores1, scores2, scores3, scores4, scores5, scores6;		// from configstrings
